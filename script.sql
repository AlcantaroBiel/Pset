...
--Coloca padrões nas colunas que podem receber NULL na tabela clientes;
/*ALTER TABLE lojas.clientes ALTER COLUMN telefone1 SET DEFAULT 'Telefone desconhecido';
ALTER TABLE lojas.clientes ALTER COLUMN telefone2 SET DEFAULT 'Telefone desconhecido';
ALTER TABLE lojas.clientes ALTER COLUMN telefone3 SET DEFAULT 'Telefone desconhecido';*/
...
--Coloca padrões nas colunas que podem receber NULL na tabela produtos;
/*ALTER TABLE lojas.produtos ALTER COLUMN preco_unitario			  SET DEFAULT '0.00';
ALTER TABLE lojas.produtos ALTER COLUMN detalhes 				  SET DEFAULT 'Detalhes não informados';
ALTER TABLE lojas.produtos ALTER COLUMN imagem					  SET DEFAULT 'Imagem desconhecida';
ALTER TABLE lojas.produtos ALTER COLUMN imagem_mime_type 		  SET DEFAULT 'Tipo de media desconhecida';
ALTER TABLE lojas.produtos ALTER COLUMN imagem_arquivo			  SET DEFAULT 'Arquivo de imagem desconhecido';
ALTER TABLE lojas.produtos ALTER COLUMN imagem_charset 			  SET DEFAULT 'Charset desconhecido';
ALTER TABLE lojas.produtos ALTER COLUMN imagem_ultima_atualizacao SET DEFAULT CURRENT_DATE;*/
...
--*ADCIONAR CONSTRAINT DA COLUNA numero_da_linha*
...
COMMENT ON COLUMN lojas.pedidos_itens.numero_da_linha IS '*ADCIONAR COMENTARIO DA COLUNAS numero_da_linha*';
